A simple web3 application that connects to MetaMask and executes a SimpleStorage solidity contract.
...
```
git clone https://github.com/hadesbaker/basic-fullstack-web3
cd basic-fullstack-web3
yarn
yarn build
```
